...
class Passcode extends Component {
  ...
  buttonDisable = () => {
    setTimeout(() => {
      if (
        ...
        this.state.codeFive !== '' &&
        this.state.codeSix !== '' &&
        this.state.codeSeven !== '' &&
        this.state.codeEight !== ''
      ) {
  ...
  submitPasscode = props => () => {
    ...
    if (!passRegex.test(passcodeOne) || !passRegex.test(passcodeTwo)) {
      showAlert(
        'Oops!',
        'Passcode must not contain same digits',
        'danger',
        'Close',
      );
      ...
      //     dob:
      //       tempDob !== '' && tempDob
      //         ? moment(tempDob).format('MM-DD-YYYY')
      //         : null,
      //     height: tempHeight,
      //     weight: tempWeight,
      ...
      //       showAlert(
      //         'Oops!',
      //         'User already registered in ZUL system',
      //         'danger',
      //         'Close',
      //       );
      //     }
      ...
      //   });
      showAlert('Congo!', 'Passcode matched!!!', 'info', 'Close');
    } else {
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.reEnterLabel}>Re-enter Passcode:</Text>
        <View style={styles.rowDirection}>
          <View style={styles.flexOne}>
            <TextInput
              ref={this.generateR5}
