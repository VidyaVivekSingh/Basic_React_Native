...
import {
  Platform, View, StyleSheet, TextInput, TouchableOpacity, PermissionsAndroid
} from 'react-native';
...
const styles = StyleSheet.create({
  ...
  label: {
    fontFamily: 'System', marginLeft: 5, color: '#000', fontSize: 20, marginBottom: 10
  },
  rowDirection: { flexDirection: 'row' },
  flexOne: { flex: 1 },
  resendOtpContainer: { flexDirection: 'row', alignSelf: 'center', marginTop: 20 },
  resendOtpIcon: {
    fontSize: 13, color: '#000', marginVertical: 19, ...regularButtonFont
  },
  resendOtpText: {
    marginLeft: 3, marginVertical: 10, padding: 5, textAlign: 'center', color: '#000', ...regularButtonFont, flexDirection: 'column'
  },
